...
/* harmony import */ var _Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Todo/todo.js */ "./src/Todo/todo.js");
/* harmony import */ var _TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TodoList/todolist.js */ "./src/TodoList/todolist.js");
...
const myTodo1 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo1.setCategory('jiujitsu');
myTodo1.setPriority('low');
myTodo1.setDueDate('2020-05-20');

const myTodo2 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo2.setCategory('jiujitsu');
myTodo2.setPriority('low');
myTodo2.setDueDate('2020-05-20');
myTodo2.markCompleted();

const myTodo3 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo3.setCategory('jiujitsu');
myTodo3.setPriority('low');
myTodo3.setDueDate('2020-05-20');

const myTodo4 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo4.setCategory('jiujitsu');
myTodo4.setPriority('low');
myTodo4.setDueDate('2020-05-20');
myTodo4.markCompleted();

const myTodo5 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo5.setCategory('jiujitsu');
myTodo5.setPriority('low');
myTodo5.setDueDate('2020-05-20');
myTodo5.markCompleted();

const myTodo6 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo6.setCategory('jiujitsu');
myTodo6.setPriority('low');
myTodo6.setDueDate('2020-05-20');
myTodo6.markCompleted();

const myTodo7 = (0,_Todo_todo_js__WEBPACK_IMPORTED_MODULE_5__.Todo)('Going to Jiujitsu', 'Today is the day I go');
myTodo7.setCategory('jiujitsu');
myTodo7.setPriority('low');
myTodo7.setDueDate('2020-05-20');
myTodo7.markCompleted();

_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo1);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo2);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo3);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo4);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo5);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo6);
_TodoList_todolist_js__WEBPACK_IMPORTED_MODULE_6__.todoList.addTodo(myTodo7);
...
const makeTodoListMain = (todos) => {
  ...
  todos.forEach(todo => {
    todoListMain.appendChild((0,_todoListMainRows_js__WEBPACK_IMPORTED_MODULE_0__.makeTodoListMainRows)(todo));
  })
...
const enableCheckMarkers = () => {
  ...
  checkMarkers.forEach(checkMarker => {
    checkMarker.addEventListener('click', () => {
      const todoItem = _get_js__WEBPACK_IMPORTED_MODULE_0__.get.todoItemOfCheckMarker(checkMarker);
