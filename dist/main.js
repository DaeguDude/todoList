...
const makeNavBarCategoryList = () => {
  ...
  categories.forEach(category => {
    ...
    (0,_categoryItem_js__WEBPACK_IMPORTED_MODULE_0__.enableCategoryItemToShowTodos)(categoryItem);
...
const showTodoDetails = (todo) => {
  ...
  const todoDetailsCardView = (0,_elements_makeTodoDetailsCardView_js__WEBPACK_IMPORTED_MODULE_0__.makeTodoDetailsCardView)(todo);
